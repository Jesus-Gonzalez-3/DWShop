    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSwaggerGen(x => { 
                ...
                { Title = "Tienda en linea DW", Version = "v1" 
                }); 
                x.AddSecurityDefinition(StorageConstants.Local.Scheme,
            ...
            // aqui configuramos las opciones del inicio de sesion del usuario.
